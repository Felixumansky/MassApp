...
/** Downscale an image file to a JPEG data URL (long edge ≤ maxEdge) so it fits localStorage and the sync payload. */
export function compressImage(file, maxEdge = 800, quality = 0.7) {
