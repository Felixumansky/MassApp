  ...
  return (
    <>
      ...
      <motion.form
        ...
        className="solid shadow-[var(--shadow-overlay)] fixed inset-x-0 bottom-0 z-50 mx-auto flex max-h-[90dvh] max-w-md flex-col rounded-t-2xl p-5 pb-[max(1.25rem,var(--safe-b))]"
